...
fecha_factiracion = ft.TextField(label='Fecha Facturación',
...
price_item_1 = ft.TextField(label='Price Item 1',
                            value='0',
                            text_align='center',
                            width=150)

price_item_2 = ft.TextField(label='Price Item 2',
                            value='0',
                            text_align='center',
                            width=150)
...
def generar_factura(datos):
    ...
    with zipfile.ZipFile('facturas.docx', 'w') as zipf:
...
def main(page: ft.Page):
    ...
    titulo = ft.Text('Creación de Factura',
                    style=ft.TextThemeStyle.HEADLINE_LARGE)

    def obtener_datos(e):
        data_factura = {
            '%FECHA%': fecha_factiracion.value,
    ...
    page.add(titulo,
            ft.Row(controls=[fecha_factiracion, numero_factura]),
